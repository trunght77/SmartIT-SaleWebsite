			...
			<div class="row">
						...
						<div class="col-md-6">
							<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
								...
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="shop.php?category=Fruits&page=1">Fruits</a></h2>
								</div>
							</div>
							<div class="category-wrap ftco-animate img d-flex align-items-end"
								style="background-image: url(images/category-2.jpg);">
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="shop.php?category=Vegetables&page=1">Vegetables</a></h2>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
						...
						<div class="text px-3 py-1">
							<h2 class="mb-0"><a href="shop.php?category=Juices&page=1">Juices</a></h2>
						</div>
					</div>
					<div class="category-wrap ftco-animate img d-flex align-items-end"
						style="background-image: url(images/category-4.jpg);">
						<div class="text px-3 py-1">
							<h2 class="mb-0"><a href="shop.php?category=Dried&page=1">Dried</a></h2>
						</div>
					</div>
				</div>
			</div>
